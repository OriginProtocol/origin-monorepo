...
| Branch  | CI/CD Status |
| ------------- | ------------- |
| `master` | [![OUSD](https://github.com/OriginProtocol/origin-monorepo/actions/workflows/ousd.yml/badge.svg)](https://github.com/OriginProtocol/origin-monorepo/actions/workflows/ousd.yml) |
| `staging` | [![OUSD](https://github.com/OriginProtocol/origin-monorepo/actions/workflows/ousd.yml/badge.svg?branch=staging)](https://github.com/OriginProtocol/origin-dollar/actions/workflows/ousd.yml?query=branch%3Astaging) |
